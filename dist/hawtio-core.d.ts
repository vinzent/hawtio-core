...
declare namespace About {
    class AboutController {
        ...
        open: boolean;
        constructor($rootScope: ng.IScope, aboutService: AboutService);
        $onInit(): void;
        get title(): string;
...
declare namespace Core {
    ...
    class AuthService {
        ...
        private _token;
        private _loggedIn;
        constructor(postLoginTasks: Tasks, preLogoutTasks: Tasks, postLogoutTasks: Tasks);
        /**
...
declare namespace Core {
    ...
    function applyBranding(configManager: ConfigManager): void;
}
declare namespace Core {
...
declare namespace Core {
    class PatternFlyService {
        filter<T>(items: T[], filterConfig: any): T[];
    }
}
declare namespace Core {
...
declare namespace Page {
    const pageHeaderComponent: angular.IComponentOptions;
}
declare namespace Page {
    const pageHeaderModule: string;
}
declare namespace Page {
    const pageMainComponent: angular.IComponentOptions;
}
declare namespace Page {
    const pageMainModule: string;
}
...
declare namespace Page {
    const pageSidebarComponent: angular.IComponentOptions;
}
declare namespace Page {
    const pageSidebarModule: string;
}
declare namespace Page {
    const pageComponent: angular.IComponentOptions;
}
declare namespace Page {
    const pageModule: string;
}
declare namespace Nav {
    ...
    const appLauncherComponent: ng.IComponentOptions;
}
declare namespace Nav {
    class ContextSelectorController {
        private $timeout;
        ...
        toggle(): void;
        reset(): void;
        onSearchKeyUp($event: JQueryEventObject): void;
        onItemKeyUp($event: JQueryEventObject): void;
        filterItems(): void;
        onItemClick(item: ContextSelectorItem): void;
        isItemSelected(): boolean;
        focusSelectedItem(): void;
        kebabCase(str: string): string;
        focusSearchInput(): void;
        focusFirstItem(): void;
        focusPreviousItem(button: Element): void;
        focusNextItem(button: Element): void;
        isFirstItem(button: Element): boolean;
    }
    const contextSelectorComponent: ng.IComponentOptions;
}
declare namespace Nav {
    class HawtioTab {
...
declare namespace Nav {
    class HawtioTabsController {
        ...
        private activateTab;
        private adjustTabs;
        get visibleTabs(): HawtioTab[];
        get moreTabs(): HawtioTab[];
...
declare namespace About {
    const SHOW_ABOUT_EVENT = "ABOUT_LINK_CLICK_EVENT";
}
declare namespace Nav {
    const helpDropdownComponent: angular.IComponentOptions;
}
declare namespace Nav {
    const userDropdownComponent: angular.IComponentOptions;
}
declare namespace Nav {
...
declare namespace Page {
    const CLOSE_MAIN_NAV_EVENT = "CLOSE_MAIN_NAV_EVENT";
}
